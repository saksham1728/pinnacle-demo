  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Proposals & Quotations</h1>
          <p className="text-gray-600 mt-1">Create and track proposals with e-signatures</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-75 mt-1">{proposals.length} proposals</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-3xl font-bold">₹{(acceptedValue / 100000).toFixed(1)}L</p>
          <p className="text-sm opacity-75 mt-1">{conversionRate}% conversion</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
          ...
          <p className="text-sm opacity-75 mt-1">Awaiting response</p>
        </div>

        <div className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-xl shadow-lg p-6 text-white">
          <div className="flex items-center gap-2 mb-2">
            <Eye className="w-5 h-5" />
            <span className="text-sm opacity-90">Avg. Views</span>
          </div>
          <p className="text-3xl font-bold">
            {(proposals.reduce((sum, p) => sum + p.viewCount, 0) / proposals.length).toFixed(1)}
          </p>
          <p className="text-sm opacity-75 mt-1">Per proposal</p>
        </div>
      </div>

      {/* Proposals List */}
      <div className="bg-white rounded-xl shadow-sm p-6">
        <h2 className="text-xl font-bold text-gray-900 mb-6">All Proposals</h2>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b">
                <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Proposal ID</th>
                ...
                <th className="text-left py-3 px-4 text-sm font-semibold text-gray-700">Sent Date</th>
